...
#include <memory>
#include "../../../Widget_Client/MessageWidget.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_MessageWidget_t, stringdata0) + ofs), len 
...
const QMetaObject MessageWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_MessageWidget.offsetsAndSize,
